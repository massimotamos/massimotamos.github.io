...
![image]({{ site.baseurl }}/assets/images/post5/post5-11.jpg)
...
After trial and error I got the injection/authentication bypass right with payload (also password will be suplied as 123 on GET parameter):
...
In the upload-test.php I also identified the upload folder in 
```php
$destination = $_SERVER["DOCUMENT_ROOT"]."/images/";
```
this was the same folder on my initial inspection so we do not need any more abra kadabra to move around.
